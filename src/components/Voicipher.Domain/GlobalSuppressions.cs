...
[assembly: SuppressMessage("Design", "CA1056:Uri properties should not be strings", Justification = "By design.", Scope = "member", Target = "~P:Voicipher.Domain.Settings.NotificationSettings.BaseUrl")]
