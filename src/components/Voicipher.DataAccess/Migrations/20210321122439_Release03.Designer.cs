...
namespace Voicipher.DataAccess.Migrations
{
    ...
    [Migration("20210321122439_Release03")]
    partial class Release03
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voicipher.Domain.Models.AudioFile", b =>
                {
                    ...
                    b.Property<TimeSpan>("TranscriptionEndTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("TranscriptionStartTime")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Voicipher.Domain.Models.PurchaseStateTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BillingPurchaseId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("PreviousPurchaseState")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.HasIndex("BillingPurchaseId");

                    b.ToTable("PurchaseStateTransaction");
                });
            ...
            modelBuilder.Entity("Voicipher.Domain.Models.PurchaseStateTransaction", b =>
                {
                    b.HasOne("Voicipher.Domain.Models.BillingPurchase", null)
                        .WithMany("PurchaseStateTransactions")
                        .HasForeignKey("BillingPurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Voicipher.Domain.Models.BillingPurchase", b =>
                {
                    b.Navigation("PurchaseStateTransactions");
                });
